...
import { n as Search, s as ListFilter, y as ArrowRight } from "../_libs/lucide-react.mjs";
...
function DashboardIndex() {
	...
	const getStatusStyle = (status) => {
		switch (status) {
			...
			case "Awaiting review": return "bg-red-50 text-red-600 border-red-100";
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			}), tasks.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
		...
		}), tasks.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
								...
								children: "Post a Job"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "w-4.5 h-4.5 text-[#00726D] transition-transform duration-300 group-hover:translate-x-1" })]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: "w-4.5 h-4.5" })
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ListFilter, { className: "w-3.5 h-3.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Court Location" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								className: "inline-flex h-[38px] items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 font-secondary text-xs font-medium text-gray-700 transition hover:bg-gray-50 focus:outline-none cursor-pointer",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ListFilter, { className: "w-3.5 h-3.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Budget" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								className: "inline-flex h-[38px] items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 font-secondary text-xs font-medium text-gray-700 transition hover:bg-gray-50 focus:outline-none cursor-pointer",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ListFilter, { className: "w-3.5 h-3.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Status" })]
							})
						]
					})]
				}),
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "px-6 py-4 text-left w-12" }),
								...
								children: filteredTasks.length > 0 ? filteredTasks.map((task) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
								...
								}, task.id)) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
									colSpan: 7,
