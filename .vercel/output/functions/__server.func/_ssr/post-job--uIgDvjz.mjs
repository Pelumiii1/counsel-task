...
function PostJobPage() {
  ...
  const [practiceArea, setPracticeArea] = (0, import_react.useState)(
    'Property Law',
  )
  ...
  const [confidentiality, setConfidentiality] = (0, import_react.useState)(
    'standard',
  )
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('section', {
        className:
          'w-full bg-[#f3f4f6]/50 px-6 py-6 sm:px-12 sm:py-8 border-b border-gray-100 flex flex-col gap-1 select-none',
        children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('section', {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                ...
                children:
                  'Describe what you need. Verified lawyers matching your practice area will be able to submit proposals.',
              }),
            ],
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('form', {
            ...
            className:
              'mt-8 bg-white border border-gray-150 rounded-2xl shadow-[0_4px_25px_rgba(0,0,0,0.02)] p-6 sm:p-8 flex flex-col gap-6',
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('label', {
                className: labelClass,
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('span', {
                    children: ['Task Title ', requiredMark],
                  }),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                    className:
                      'w-full rounded-lg border border-[#dedfe3] bg-white overflow-hidden focus-within:border-[#00726D]/50 focus-within:ring-2 focus-within:ring-[#00726D]/10',
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                        className:
                          'h-10 border-b border-[#dedfe3] bg-[#f9fafb] px-3 flex items-center gap-4 text-gray-500 select-none',
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            'button',
                            {
                              type: 'button',
                              className:
                                'p-1 hover:text-black hover:bg-gray-200/50 rounded transition cursor-pointer',
                              children: /* @__PURE__ */ (0,
                              import_jsx_runtime.jsx)(Bold, {
                                className: 'w-4 h-4',
                              }),
                            },
                          ),
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            'button',
                            {
                              ...
                              className:
                                'p-1 hover:text-black hover:bg-gray-200/50 rounded transition cursor-pointer',
                              children: /* @__PURE__ */ (0,
                              import_jsx_runtime.jsx)(ListOrdered, {
                                className: 'w-4 h-4',
                              }),
                            },
                          ),
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            'button',
                            {
                              ...
                              className:
                                'p-1 hover:text-black hover:bg-gray-200/50 rounded transition cursor-pointer',
                              children: /* @__PURE__ */ (0,
                              import_jsx_runtime.jsx)(RotateCw, {
                                className: 'w-4 h-4',
                              }),
                            },
                          ),
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('textarea', {
                        ...
                        className:
                          'w-full h-32 px-4 py-3 text-sm font-normal text-[#242424] placeholder-gray-400 focus:outline-none resize-none',
                      }),
                    ],
                  }),
                ],
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('label', {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('span', {
                        children: ['Practice Area ', requiredMark],
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('input', {
                        type: 'text',
                        value: practiceArea,
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('label', {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('span', {
                        children: ['Court Location ', requiredMark],
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('input', {
                        type: 'text',
                        value: courtLocation,
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('label', {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('span', {
                        children: ['Deadline ', requiredMark],
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('input', {
                        type: 'text',
                        value: deadline,
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('label', {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('span', {
                            children: ['Proposed Fee ', requiredMark],
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('input', {
                            type: 'text',
                            value: proposedFee,
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                        className:
                          'flex gap-2 rounded-lg border border-orange-200 bg-orange-50 px-3.5 py-2.5 text-xs text-orange-800 items-start select-none leading-relaxed',
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Info, {
                            className:
                              'w-4 h-4 text-orange-600 shrink-0 mt-0.5',
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                            children:
                              'The minimum fee for Property Law tasks is ₦30,000. Proposed fees below this amount cannot be submitted.',
                          }),
                        ],
                      }),
                    ],
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('span', {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                        className:
                          'ml-1 text-[11px] text-gray-500 font-normal bg-gray-100 px-2 py-0.5 rounded',
                        children:
                          'Only upload client instructions. Do not upload confidential documents.',
                      }),
                    ],
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                    className:
                      'border border-dashed border-gray-300 rounded-xl bg-[#f9fafb] p-6 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-gray-100/50 transition',
                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                      'label',
                      {
                        className:
                          'flex flex-col items-center cursor-pointer w-full',
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                            className:
                              'w-10 h-10 rounded-full bg-white shadow-sm flex items-center justify-center mb-3',
                            children: /* @__PURE__ */ (0,
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                            className:
                              'mt-1 text-[11px] text-gray-400 font-normal',
                            children:
                              'Required Upload documents include PDF, Word Documents and Images',
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('input', {
                            type: 'file',
              ...
              error
                ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                    className:
                      'rounded-lg border border-red-200 bg-red-50 px-4 py-3 font-secondary text-sm text-red-700',
                    children: error,
                  })
                : null,
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)('button', {
                    ...
                    className:
                      'inline-flex h-11 items-center justify-center rounded-lg border border-gray-300 bg-white px-6 font-secondary text-sm font-medium text-gray-700 transition hover:bg-gray-50 active:scale-[0.98] focus:outline-none cursor-pointer',
                    children: 'Save to draft',
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)('button', {
                    type: 'submit',
                    className:
                      'inline-flex h-11 items-center justify-center rounded-lg bg-[#00726d] px-6 font-secondary text-sm font-medium text-white transition hover:bg-[#005c58] active:scale-[0.98] focus:outline-none cursor-pointer',
                    children: 'Post Task',
                  }),
                ],
              }),
