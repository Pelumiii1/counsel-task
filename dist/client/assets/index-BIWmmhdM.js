...
` +
    ...
    function ho(e) {
      e.tag === 22 ? (O(P, P.current), O(uo, e), fo === null && (fo = e)) : N(e)
    }
    function N() {
        ...
        (this.buildLocation = (e) => {
          let t = (t = {}) => {
              ...
              let h = this.options.stringifySearch(m),
                ...
                _ = g ? `#${g}` : ``,
                v =
                  t.state === !0 ? n.state : t.state ? re(t.state, n.state) : {}
              v = le(n.state, v)
              let y = `${p}${h}${_}`,
                b,
                x,
...
async function _o(e, t = {}) {
  ...
  return { t: await ha(n, e), f: n.base.features, m: Array.from(n.base.marked) }
}
function vo(e) {
  return e
}
...
function Tc(e) {
  return new Ec(e, { silent: !0 }).createRoute
}
var Ec = class {
  constructor(e, t) {
    ;((this.path = e),
...
var Mc = (e, t) =>
  ...
  Nc = (e, t) => e[0] === t[0] && e[1] === t[1],
  Pc = z.memo(function ({ matchId: e }) {
    let t = Es(),
...
function Fc({ router: e, matchId: t, resetKey: n, matchState: r }) {
  let i = e.routesById[r.routeId],
    ...
    f = s ? ys : Ac,
    p = l ? Oc : Ac
  return (0, B.jsxs)(i.isRoot ? (i.options.shellComponent ?? Ac) : Ac, {
    children: [
      (0, B.jsx)(Ds.Provider, {
        value: t,
        children: (0, B.jsx)(d, {
            ...
            children: (0, B.jsx)(p, {
              ...
              children:
                u || r._displayPending
                  ? (0, B.jsx)(Ss, {
                      fallback: o,
                      children: (0, B.jsx)(Lc, { matchId: t }),
                    })
                  : (0, B.jsx)(Lc, { matchId: t }),
            }),
          }),
        }),
      }),
      r.parentRouteId === `__root__`
        ? (0, B.jsxs)(B.Fragment, {
            children: [(0, B.jsx)(Ic, {}), (e.options.scrollRestoration, null)],
          })
        : null,
    ],
  })
...
var Lc = z.memo(function ({ matchId: e }) {
    let t = Es(),
    ...
    let i = H(r, (e) => e),
      ...
      c = z.useMemo(() => {
        ...
        return e ? (0, B.jsx)(e, {}, s) : (0, B.jsx)(Rc, {})
    ...
    if (i.status === `notFound`) return (ct(i.error) || we(), jc(t, o, i.error))
  ...
  Rc = z.memo(function () {
      ...
      i
    {
      ...
      ;(([n, r] = H(a, (e) => [e?.routeId, e?.globalNotFound ?? !1], Nc)),
    ...
    let a = n ? e.routesById[n] : void 0,
      o = e.options.defaultPendingComponent
        ...
        : null
    if (r) return (a || we(), jc(e, a, void 0))
    if (!i) return null
    let s = (0, B.jsx)(Pc, { matchId: i })
    return n === `__root__`
...
function zc() {
  let e = Es(),
    ...
    n = t ? (0, B.jsx)(t, {}) : null,
    r = (0, B.jsxs)(typeof document < `u` && e.ssr ? Ac : z.Suspense, {
      fallback: n,
      children: [(0, B.jsx)(U, {}), (0, B.jsx)(Bc, {})],
    })
...
function Wc({ router: e, children: t, ...n }) {
  oe(n) &&
    e.update({
      ...e.options,
      ...n,
...
function Gc({ router: e, ...t }) {
  return (0, B.jsx)(Wc, { router: e, ...t, children: (0, B.jsx)(zc, {}) })
}
function Kc(e, t) {
  if (t)
...
function qc(e) {
  ...
  switch (e.tag) {
    ...
    case `script`:
      return (0, B.jsx)(Jc, { attrs: t, preventScriptHoist: i, children: n })
    default:
      return null
  }
}
function Jc({ attrs: e, children: t, preventScriptHoist: n }) {
  Es()
  let r = Cs(),
    i =
    ...
    (z.useEffect(() => {
      if (!i) {
        if (e?.src) {
          ...
          return (Kc(n, e), document.head.appendChild(n), () => n.remove())
        }
        if (typeof t == `string`) {
...
function Xc(e) {
  let t = Yc(e.assetCrossOrigin),
    n = Es().options.ssr?.nonce
  return (0, B.jsx)(B.Fragment, {
    children: t.map((e) =>
      (0, z.createElement)(qc, {
        ...e,
...
var Zc = () => {
  ...
  return Qc(e, H(e.stores.matches, r, E), i)
}
function Qc(e, t, n) {
  let r = [...t, ...n]
  return (0, B.jsx)(B.Fragment, {
    children: r.map((e, t) =>
      (0, z.createElement)(qc, { ...e, key: `tsr-scripts-${e.tag}-${t}` }),
    ),
  })
}
var $c = (...e) =>
    e
      ...
      .join(` `)
      .trim(),
  el = (e) => e.replace(/([a-z0-9])([A-Z])/g, `$1-$2`).toLowerCase(),
  tl = (e) =>
  ...
  ol = (e, t) => {
    let n = (0, z.forwardRef)(({ className: n, ...r }, i) =>
      (0, z.createElement)(al, {
        ref: i,
        iconNode: t,
        className: $c(`lucide-${el(nl(e))}`, `lucide-${e}`, n),
        ...r,
      }),
    )
    return ((n.displayName = nl(e)), n)
  },
  sl = ol(`arrow-left`, [
          ...
          (0, B.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, B.jsxs)(`button`, {
                ...
                children: [(0, B.jsx)(sl, { className: `w-4 h-4` }), `Go Back`],
              }),
            ],
          }),
        ],
...
var ll = `/assets/styles-DUTQRFGh.css`,
  ul = wc({
    head: () => ({
      meta: [
        { charSet: `utf-8` },
...
function dl({ children: e }) {
  return (0, B.jsxs)(`html`, {
    lang: `en`,
    children: [
      (0, B.jsx)(`head`, { children: (0, B.jsx)(Xc, {}) }),
      (0, B.jsxs)(`body`, { children: [e, (0, B.jsx)(Zc, {})] }),
    ],
  })
}
var fl = `modulepreload`,
  pl = function (e) {
    return `/` + e
  },
  ml = {},
  hl = function (e, t, n) {
    ...
    if (t && t.length > 0) {
      ...
      r = o(
        t.map((t) => {
          if (((t = pl(t, n)), (t = s(t)), t in ml)) return
          ml[t] = !0
  ...
  gl = {
    landingpageIndexRoute: Tc(`/(landingpage)/`)({
      component: Dc(
        () => hl(() => import(`./(landingpage)-bvUhvv84.js`), []),
        `component`,
      ),
    }).update({ id: `/(landingpage)/`, path: `/`, getParentRoute: () => ul }),
  },
  _l = ul._addFileChildren(gl)
function vl() {
  return Hc({
    routeTree: _l,
    scrollRestoration: !0,
...
function Cl() {
  return (
    ...
    (0, B.jsx)(_s, {
      promise: Sl,
      children: (e) => (0, B.jsx)(Gc, { router: e }),
    })
  )
}
var wl = g()
;(0, z.startTransition)(() => {
  ;(0, wl.hydrateRoot)(
    document,
    (0, B.jsx)(z.StrictMode, { children: (0, B.jsx)(Cl, {}) }),
  )
})
export { u as n, c as r, hs as t }
